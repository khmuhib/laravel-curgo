@include('frontend.header')
                ...
                <ul>
                    ...
                    <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-3-layer-9"
                            ...
                            style="z-index: 5;"><img src="{{ asset('frontend/images/main-slider/slide-bg.png') }}"
                                alt="" data-ww="['674px','674px','674px','674px']"
                    ...
                    <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-2-layer-9"
                            ...
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                            style="z-index: 5;"><img src="{{ asset('frontend/images/main-slider/slide-bg.png') }}"
                                alt="" data-ww="['755px','755px','755px','755px']"
        ...
        <div class="welcomesec secpadd">
            <div class="container">
                ...
                <p class="haeadingpara text-center paddbtm40">Usa Logistics Ltd is more than logistics.
        ...
        <section class="homecounts">
            <div class="container">
                <h2 class="count-title">Usa <span class="main-color">Logistics Ltd</span> is a Global Supplier of Transport
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6  secpaddlf">
                        ...
                        <div class="fh-icon-box  style-2 icon-left">
                            ...
                            <div class="desc">
                                <p>Usa Logistics Ltd are transported at some stage of their journey along the world’s roads</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="fh-testimonials-carousel fh-testimonials column-1">
                <div class="testi-list  single-slide">
                    <div class="testi-wrapper"
                        style="background-image:url({{ 'frontend/images/main-slider/testi-1.jpg' }})">
                        <div class="container">
                    ...
                    <div class="testi-wrapper"
                        style="background-image:url({{ url('frontend/images/main-slider/testi-3.jpg') }})">
                        <div class="container">
                            <div class="testi-item">
                                <span class="testi-icon"><i class="flaticon-quotations "></i></span>
                                <div class="testi-content">
                    ...
                    <div class="testi-wrapper"
                        style="background-image:url({{ url('frontend/images/main-slider/testi-2.jpg') }})">
                        <div class="container">
                            <div class="testi-item">
                                <span class="testi-icon"><i class="flaticon-quotations "></i></span>
                                <div class="testi-content">
                    ...
                    <div class="post-list  news-slide">
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="{{ asset('frontend/images/blogs/blog-1.jpg') }}"
                                        alt="" /></a>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="{{ asset('frontend/images/blogs/blog-2.jpg') }}"
                                        alt="" /></a>
                                <div class="entry-time">
                                    <span class="day">09</span>
                                    <span class="month">Aug</span>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="{{ asset('frontend/images/blogs/blog-3.jpg') }}"
                                        alt="" /></a>
                                <div class="entry-time">
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="{{ asset('frontend/images/blogs/blog-4.jpg') }}"
                                        alt="" /></a>
                                <div class="entry-time">
                                    <span class="day">26</span>
                                    <span class="month">Jul</span>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="{{ asset('frontend/images/blogs/blog-5.jpg') }}"
                                        alt="" /></a>
                                <div class="entry-time">
                                    <span class="day">26</span>
                                    <span class="month">Jul</span>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="{{ asset('frontend/images/blogs/blog-6.jpg') }}"
                                        alt="" /></a>
                                <div class="entry-time">
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="{{ asset('frontend/images/blogs/blog-7.jpg') }}"
                                        alt="" /></a>
                                <div class="entry-time">
                                    <span class="day">09</span>
                                    <span class="month">Aug</span>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="{{ asset('frontend/images/blogs/blog-8.jpg') }}"
                                        alt="" /></a>
                                <div class="entry-time">
                                    <span class="day">09</span>
                                    <span class="month">Aug</span>
