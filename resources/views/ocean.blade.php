@include('frontend.header')
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <h1 class="page-title">Ocean Service</h1> </div>
                    </div>
                </div>
            </div>
        ...
        <div class="service_dtl1 secpadd">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        @include('frontend.service-sidebar')
                    </div>
                    <div class="col-md-9">
                        <div class="servdtlimg margbtm30">
                            <img src="{{ asset('frontend/images/services/slide1-3.jpg') }}" alt="" />
                        </div>
                                    ...
                                    <div class="list-item partener_slide2">
                                        <div class="partner-item">
                                            <div class="partner-content">
                                                <a href="#" target="_self"><img alt="" src="{{ asset('frontend/images/partener/client1.png') }}"></a>
                                            </div>
                                        </div>
                                        <div class="partner-item">
                                            <div class="partner-content">
                                                <a href="#" target="_self"><img alt="" src="{{ asset('frontend/images/partener/client2.png') }}"></a>
                                            </div>
                                        </div>
                                        <div class="partner-item">
                                            <div class="partner-content">
                                                <a href="#" target="_self"><img alt="" src="{{ asset('frontend/images/partener/client3.png') }}"></a>
                                            </div>
                                        </div>
                                        <div class="partner-item">
                                            <div class="partner-content">
                                                <a href="#" target="_self"><img alt="" src="{{ asset('frontend/images/partener/client4.png') }}"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
